package com.rescuesimulation.tests;
...
public class M1PublicTests {
    ...
    String simulatorPath = "com.rescuesimulation.simulation.Simulator";
    String addressPath = "com.rescuesimulation.simulation.Address";
    String rescuablePath = "com.rescuesimulation.simulation.Rescuable";
    String simulatablePath = "com.rescuesimulation.simulation.Simulatable";
    String residentialBuildingPath = "com.rescuesimulation.model.infrastructure.ResidentialBuilding";
    String citizenStatePath = "com.rescuesimulation.model.people.CitizenState";
    String unitStatePath = "com.rescuesimulation.model.units.UnitState";
    String citizenPath = "com.rescuesimulation.model.people.Citizen";
    String unitPath = "com.rescuesimulation.model.units.Unit";
    String policeUnitPath = "com.rescuesimulation.model.units.PoliceUnit";
    String fireUnitPath = "com.rescuesimulation.model.units.FireUnit";
    String medicalUnitPath = "com.rescuesimulation.model.units.MedicalUnit";
    String evacuatorPath = "com.rescuesimulation.model.units.Evacuator";
    String fireTruckPath = "com.rescuesimulation.model.units.FireTruck";
    String gasControlUnitPath = "com.rescuesimulation.model.units.GasControlUnit";
    String ambulancePath = "com.rescuesimulation.model.units.Ambulance";
    String diseaseControlUnitPath = "com.rescuesimulation.model.units.DiseaseControlUnit";
    String disasterPath = "com.rescuesimulation.model.disasters.Disaster";
    String collapsePath = "com.rescuesimulation.model.disasters.Collapse";
    String firePath = "com.rescuesimulation.model.disasters.Fire";
    String gasLeakPath = "com.rescuesimulation.model.disasters.GasLeak";
    String infectionPath = "com.rescuesimulation.model.disasters.Infection";
    String injuryPath = "com.rescuesimulation.model.disasters.Injury";
    String commandCenterPath = "com.rescuesimulation.controller.CommandCenter";

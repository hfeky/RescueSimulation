package com.rescuesimulation.simulation;

import com.rescuesimulation.model.disasters.*;
import com.rescuesimulation.model.infrastructure.ResidentialBuilding;
import com.rescuesimulation.model.people.Citizen;
import com.rescuesimulation.model.units.*;
...
public class Simulator {
    ...
    public Simulator() throws Exception {
        ...
        loadBuildings(INPUT_PATH + "buildings.csv");
        loadCitizens(INPUT_PATH + "citizens.csv");
        loadUnits(INPUT_PATH + "units.csv");
        loadDisasters(INPUT_PATH + "disasters.csv");
    }
    ...
    private void loadCitizens(String filePath) throws Exception {
        ...
        while (input.hasNext()) {
            String[] cells = input.nextLine().split(",");
            citizens.add(new Citizen(world[Integer.parseInt(cells[0])][Integer.parseInt(cells[1])],
